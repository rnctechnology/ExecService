 ...
 * @since 2020.09
 */
public class OutputChangeWatcher extends Thread {
  Logger logger = LoggerFactory.getLogger(OutputChangeWatcher.class);

  private WatchService watcher;
  private final List<File> watchFiles = new LinkedList<>();
  private final Map<WatchKey, File> watchKeys = new HashMap<>();
  private OutputChangeListener listener;
  private boolean stop;

  public OutputChangeWatcher(OutputChangeListener listener)
      throws IOException {

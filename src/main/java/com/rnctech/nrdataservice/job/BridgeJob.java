...
public class BridgeJob extends RNJob {
	
	public BridgeJob() {};

	public BridgeJob(JobPolicy policy){
		super();
		this.policy = policy;
	}	
	...
	public SimpleTriggerFactoryBean getRNTrigger(JobDetail jobDetail) {
		...
		factoryBean.setGroup(JOBService.bridgrGrpName);
		factoryBean.setStartDelay(100l);
		factoryBean.setBeanName(getTriggerKeyName(BridgeJob.class.getClass()));
